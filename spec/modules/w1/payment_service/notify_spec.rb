...
describe W1::PaymentService::Notify do
  ...
  let(:vendor) { create :vendor, :with_w1, w1_md5_secret_key: '623577687055676e43446f6c474f385165356e64556e474e5d7366' }
  ...
  before do
    allow(vendor.orders).to receive(:find_by_external_id).with('kiosk:5-604-pro').and_return order
  end
